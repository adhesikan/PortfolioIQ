      ...
      <div className="rounded-lg bg-amber-50 border border-amber-200 px-4 py-3">
        <div className="flex items-start gap-2">
          ...
          <p className="text-xs text-amber-800">
            <span className="font-semibold">EXAMPLE ONLY</span> — Sample trade history for demonstration. Not financial advice. Past performance is not indicative of future results. See our <Link href="/disclaimer" className="underline hover:text-amber-950">Disclaimer</Link>.
          </p>
        </div>
      </div>
    );
